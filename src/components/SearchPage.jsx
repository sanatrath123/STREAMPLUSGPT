...
// }
  ...
  useSearchMovie()
    ...
    return (
        <div className='w-full bg-gray-600 bg-cover flex flex-wrap  justify-center ' style={{backgroundImage: `url("https://media.istockphoto.com/id/1294603953/vector/abstract-black-stripes-diagonal-background.jpg?s=612x612&w=0&k=20&c=nQZHTk-o97cNVqWnUe8BJg0A5jQG0tqylquzbt9YtcQ=")`, height: '700px'}}>
